...
The extension is confirmed to work on Microsoft Edge, and it will probably work on any other Chromium-based browser, too. You can install it from the Chrome Web Store here.
